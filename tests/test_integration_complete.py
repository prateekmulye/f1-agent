...
@pytest.mark.asyncio
async def test_tools_initialization(mock_settings, mock_vector_store, mock_tavily_client):
...
@pytest.mark.asyncio
async def test_agent_graph_initialization(mock_settings, mock_vector_store, mock_tavily_client):
...
async def test_vector_store_with_cache(mock_settings, mock_vector_store):
    ...
    mock_vector_store._vector_store.similarity_search = MagicMock(return_value=mock_docs)

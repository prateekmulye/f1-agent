...
class TestTavilySearchIntegration:
    ...
    async def test_search_with_f1_domain(self, tavily_client: TavilySearchClient):
        ...
        assert any(keyword in content.lower() for keyword in ["f1", "formula 1", "grand prix"])

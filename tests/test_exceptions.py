...
def test_base_exception_creation():
    ...
    error = F1SlipstreamError("Test error")
...
def test_exception_with_details():
    ...
    error = F1SlipstreamError("Test error", details=details)
...
def test_exception_with_original_error():
    ...
    error = F1SlipstreamError("Wrapped error", original_error=original)
...
def test_exception_repr():
    ...
    error = F1SlipstreamError(
        "Test error",
        details={"key": "value"},
        original_error=ValueError("Original"),
    )
    repr_str = repr(error)
    assert "F1SlipstreamError" in repr_str
...
def test_configuration_error():
    ...
    assert isinstance(error, F1SlipstreamError)

...
class TestResponseTimePercentiles:
    ...
    @pytest.mark.asyncio
    async def test_vector_search_latency_p50(self, mock_vector_store: Mock):
    ...
    @pytest.mark.asyncio
    async def test_vector_search_latency_p95(self, mock_vector_store: Mock):
    ...
    @pytest.mark.asyncio
    async def test_vector_search_latency_p99(self, mock_vector_store: Mock):
    ...
    async def test_tavily_search_latency(
        ...
        with patch(
            "src.search.tavily_client.TavilySearchAPIWrapper",
...
class TestConcurrentUserLoad:
    ...
    @pytest.mark.asyncio
    async def test_10_concurrent_queries(self, mock_vector_store: Mock):
    ...
    @pytest.mark.asyncio
    async def test_50_concurrent_queries(self, mock_vector_store: Mock):
    ...
    @pytest.mark.asyncio
    async def test_100_concurrent_queries(self, mock_vector_store: Mock):
...
class TestAPILatency:
    ...
    @pytest.mark.asyncio
    async def test_openai_embedding_latency(self, mock_openai_embeddings: Mock):
    ...
    @pytest.mark.asyncio
    async def test_openai_chat_latency(self, mock_openai_chat: Mock):
    ...
    @pytest.mark.asyncio
    async def test_pinecone_upsert_latency(self, mock_pinecone_index: Mock):
    ...
    @pytest.mark.asyncio
    async def test_pinecone_query_latency(self, mock_pinecone_index: Mock):
...
class TestMemoryUsage:
    ...
    @pytest.mark.asyncio
    async def test_single_query_memory_usage(self, mock_vector_store: Mock):
    ...
    @pytest.mark.asyncio
    async def test_document_processing_memory(self, sample_documents: List[Document]):
        ...
        # Process documents
        large_doc = Document(
            page_content="Test content " * 1000, metadata={}  # Large document
        )
...
class TestThroughput:
    ...
    @pytest.mark.asyncio
    async def test_queries_per_second(self, mock_vector_store: Mock):
    ...
    @pytest.mark.asyncio
    async def test_document_ingestion_throughput(self, mock_vector_store: Mock):
        """Test document ingestion throughput."""
        documents = [
            Document(page_content=f"Document {i}", metadata={}) for i in range(1000)
        ]
        ...
        assert (
            docs_per_second >= 100
        ), f"Ingestion rate {docs_per_second} docs/s below target"
...
class TestScalability:
    ...
    @pytest.mark.asyncio
    async def test_increasing_load_performance(self, mock_vector_store: Mock):
        ...
        for load in load_levels:
            tasks = [
                mock_vector_store.similarity_search(f"query {i}") for i in range(load)
            ]
    ...
    @pytest.mark.asyncio
    async def test_large_result_set_handling(self, mock_vector_store: Mock):
        """Test handling of large result sets."""
        # Mock large result set
        large_results = [
            Document(page_content=f"Doc {i}", metadata={}) for i in range(100)
        ]
...
class TestResourceUtilization:
    ...
    @pytest.mark.asyncio
    async def test_connection_pooling_efficiency(self, mock_vector_store: Mock):
        """Test that connection pooling is efficient."""
        # Execute multiple queries
        tasks = [mock_vector_store.similarity_search(f"query {i}") for i in range(20)]
...
class TestPerformanceRegression:
    ...
    @pytest.mark.asyncio
    async def test_baseline_query_performance(self, mock_vector_store: Mock):

...
@router.post(
    ...
    description="Send a message to the F1-Slipstream chatbot and receive a response",
)
...
async def chat_stream(request: ChatRequest, http_request: Request) -> StreamingResponse:
    ...
    async def event_generator():
        ...
        try:
            ...
            async for event in compiled_graph.astream_events(initial_state, config=config, version="v1"):

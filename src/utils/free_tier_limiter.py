"""
Free Tier Rate Limiter for F1-Slipstream
        ...
        with self.lock:
            ...
            return {
                "user": {
                    ...
                    "minute_remaining": self.USER_RPM - len(self.user_requests[user_id]),
                    "daily_remaining": self.USER_RPD - self.user_daily_requests[user_id],
                },
                "openai": {
